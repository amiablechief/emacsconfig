(setq inhibit-startup-message t) ;; Disable startup modes

(set scroll-bar-mode -1) ;; Disable scrollbars
...
;; Disable audible bell and set visible bell instead
(setq visible-bell t)
...
(use-package helpful
  ;;:ensure t  ;; Download package if (setq use-package-always-ensure t) isn't set globally
  :custom
